...
JNIEXPORT jlong JNICALL Java_io_michaelrocks_xxhash_XxHash64Native_hashForArray(
...
JNIEXPORT jlong JNICALL Java_io_michaelrocks_xxhash_XxHash64Native_hashForByteBuffer(
...
JNIEXPORT jlong JNICALL Java_io_michaelrocks_xxhash_XxHash64Native_create(
...
JNIEXPORT void JNICALL Java_io_michaelrocks_xxhash_XxHash64Native_updateWithArray(
...
JNIEXPORT void JNICALL Java_io_michaelrocks_xxhash_XxHash64Native_updateWithByteBuffer(
...
JNIEXPORT void JNICALL Java_io_michaelrocks_xxhash_XxHash64Native_updateWithBoolean(
    JNIEnv *env, jclass cls, jlong state, jboolean value) {
  XXH64_update((XXH64_state_t *) state, &value, sizeof(value));
}

JNIEXPORT void JNICALL Java_io_michaelrocks_xxhash_XxHash64Native_updateWithChar(
    JNIEnv *env, jclass cls, jlong state, jchar value) {
  XXH64_update((XXH64_state_t *) state, &value, sizeof(value));
}

JNIEXPORT void JNICALL Java_io_michaelrocks_xxhash_XxHash64Native_updateWithByte(
    JNIEnv *env, jclass cls, jlong state, jbyte value) {
  XXH64_update((XXH64_state_t *) state, &value, sizeof(value));
}

JNIEXPORT void JNICALL Java_io_michaelrocks_xxhash_XxHash64Native_updateWithShort(
    JNIEnv *env, jclass cls, jlong state, jshort value) {
  XXH64_update((XXH64_state_t *) state, &value, sizeof(value));
}

JNIEXPORT void JNICALL Java_io_michaelrocks_xxhash_XxHash64Native_updateWithInt(
    JNIEnv *env, jclass cls, jlong state, jint value) {
  XXH64_update((XXH64_state_t *) state, &value, sizeof(value));
}

JNIEXPORT void JNICALL Java_io_michaelrocks_xxhash_XxHash64Native_updateWithLong(
    JNIEnv *env, jclass cls, jlong state, jlong value) {
  XXH64_update((XXH64_state_t *) state, &value, sizeof(value));
}

JNIEXPORT void JNICALL Java_io_michaelrocks_xxhash_XxHash64Native_updateWithFloat(
    JNIEnv *env, jclass cls, jlong state, jfloat value) {
  XXH64_update((XXH64_state_t *) state, &value, sizeof(value));
}

JNIEXPORT void JNICALL Java_io_michaelrocks_xxhash_XxHash64Native_updateWithDouble(
    JNIEnv *env, jclass cls, jlong state, jdouble value) {
  XXH64_update((XXH64_state_t *) state, &value, sizeof(value));
}

JNIEXPORT jlong JNICALL Java_io_michaelrocks_xxhash_XxHash64Native_digest(
    JNIEnv *env, jclass cls, jlong state) {
  return (jlong) XXH64_digest((XXH64_state_t *) state);
}

JNIEXPORT void JNICALL Java_io_michaelrocks_xxhash_XxHash64Native_reset(
    JNIEnv *env, jclass cls, jlong state, jlong seed) {
  XXH64_reset((XXH64_state_t *) state, (uint64_t) seed);
}

JNIEXPORT void JNICALL Java_io_michaelrocks_xxhash_XxHash64Native_destroy(
    JNIEnv *env, jclass cls, jlong state) {
