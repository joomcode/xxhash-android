...
JNIEXPORT jint JNICALL Java_com_joom_xxhash_XxHash32Native_hashForArray(
...
JNIEXPORT jint JNICALL Java_com_joom_xxhash_XxHash32Native_hashForByteBuffer(
...
JNIEXPORT jlong JNICALL Java_com_joom_xxhash_XxHash32Native_create(
...
JNIEXPORT void JNICALL Java_com_joom_xxhash_XxHash32Native_updateWithArray(
...
JNIEXPORT void JNICALL Java_com_joom_xxhash_XxHash32Native_updateWithByteBuffer(
...
JNIEXPORT void JNICALL Java_com_joom_xxhash_XxHash32Native_updateWithBoolean(
    JNIEnv *env, jclass cls, jlong state, jboolean value) {
  XXH32_update((XXH32_state_t *) state, &value, sizeof(value));
}

JNIEXPORT void JNICALL Java_com_joom_xxhash_XxHash32Native_updateWithChar(
    JNIEnv *env, jclass cls, jlong state, jchar value) {
  XXH32_update((XXH32_state_t *) state, &value, sizeof(value));
}

JNIEXPORT void JNICALL Java_com_joom_xxhash_XxHash32Native_updateWithByte(
    JNIEnv *env, jclass cls, jlong state, jbyte value) {
  XXH32_update((XXH32_state_t *) state, &value, sizeof(value));
}

JNIEXPORT void JNICALL Java_com_joom_xxhash_XxHash32Native_updateWithShort(
    JNIEnv *env, jclass cls, jlong state, jshort value) {
  XXH32_update((XXH32_state_t *) state, &value, sizeof(value));
}

JNIEXPORT void JNICALL Java_com_joom_xxhash_XxHash32Native_updateWithInt(
    JNIEnv *env, jclass cls, jlong state, jint value) {
  XXH32_update((XXH32_state_t *) state, &value, sizeof(value));
}

JNIEXPORT void JNICALL Java_com_joom_xxhash_XxHash32Native_updateWithLong(
    JNIEnv *env, jclass cls, jlong state, jlong value) {
  XXH32_update((XXH32_state_t *) state, &value, sizeof(value));
}

JNIEXPORT void JNICALL Java_com_joom_xxhash_XxHash32Native_updateWithFloat(
    JNIEnv *env, jclass cls, jlong state, jfloat value) {
  XXH32_update((XXH32_state_t *) state, &value, sizeof(value));
}

JNIEXPORT void JNICALL Java_com_joom_xxhash_XxHash32Native_updateWithDouble(
    JNIEnv *env, jclass cls, jlong state, jdouble value) {
  XXH32_update((XXH32_state_t *) state, &value, sizeof(value));
}

JNIEXPORT jint JNICALL Java_com_joom_xxhash_XxHash32Native_digest(
    JNIEnv *env, jclass cls, jlong state) {
  return XXH32_digest((XXH32_state_t *) state);
}

JNIEXPORT void JNICALL Java_com_joom_xxhash_XxHash32Native_reset(
    JNIEnv *env, jclass cls, jlong state, jint seed) {
  XXH32_reset((XXH32_state_t *) state, (uint32_t) seed);
}

JNIEXPORT void JNICALL Java_com_joom_xxhash_XxHash32Native_destroy(
    JNIEnv *env, jclass cls, jlong state) {
